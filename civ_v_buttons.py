    ...
    def pop_up_search():
        ...
        def search():
            ...
            try:
                ...
                win.wm_title("Test")
                win.geometry("500x350")
                Label(win, text = 'Civilian ID', borderwidth = 1).grid(row = 0, column = 0)
                Label(win, text = 'Civilian Name', borderwidth = 1).grid(row = 0, column = 1)
                Label(win, text = 'Age', borderwidth = 1).grid(row = 0, column = 2)
                Label(win, text = 'Gender', borderwidth = 1).grid(row = 0, column = 3)
                Label(win, text = 'Race', borderwidth = 1).grid(row = 0, column = 4)
                Label(win, text = 'Date of Death', borderwidth = 1).grid(row = 0, column = 5)
                Label(win, text = 'City', borderwidth = 1).grid(row = 0, column = 6)
                Label(win, text = 'State', borderwidth = 1).grid(row = 0, column = 7)
                Label(win, text = 'Cause', borderwidth = 1).grid(row = 0, column = 8)
                i = 0
                for result_dict in search_result:
                    i += 1
                    Label(win, text = result_dict['dead_civilian_id'], borderwidth = 1).grid(row = i, column = 0)
                    Label(win, text = result_dict['cname'], borderwidth = 1).grid(row = i, column = 1)
                    Label(win, text = result_dict['age'], borderwidth = 1).grid(row = i, column = 2)
                    Label(win, text = result_dict['gender'], borderwidth = 1).grid(row = i, column = 3)
                    Label(win, text = result_dict['race'], borderwidth = 1).grid(row = i, column = 4)
                    Label(win, text = result_dict['death_date'], borderwidth = 1).grid(row = i, column = 5)
                    Label(win, text = result_dict['city_name'], borderwidth = 1).grid(row = i, column = 6)
                    Label(win, text = result_dict['state_abbr'], borderwidth = 1).grid(row = i, column = 7)
                    Label(win, text = result_dict['cause'], borderwidth = 1).grid(row = i, column = 8)
